    ...
    <main style={{ minHeight: '100vh', backgroundColor: '#1c1c1e', fontFamily: 'Geist, Helvetica, Arial, sans-serif' }}>
      <nav style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '24px 50px 0' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '40px' }}>
          <a href="/studio" style={{ fontSize: '13px', color: '#666', textDecoration: 'none', letterSpacing: '0.06em' }}>Studio</a>
          <a href="/pitch" style={{ fontSize: '13px', color: '#666', textDecoration: 'none', letterSpacing: '0.06em' }}>Pitch</a>
          <a href="/about" style={{ fontSize: '13px', color: '#666', textDecoration: 'none', letterSpacing: '0.06em' }}>About</a>
