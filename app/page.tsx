    ...
    <main className="min-h-screen bg-[#EDEAE3] flex flex-col font-sans">
      ...
      <nav className="flex items-center justify-between px-11 py-7">
        ...
        <ul className="flex gap-9 list-none">
          <li><a href="#" className="text-[16px] text-[#444] tracking-[0.08em] uppercase font-normal hover:text-[#1A1A1A] transition-colors">Studio</a></li>
          <li><a href="#" className="text-[16px] text-[#444] tracking-[0.08em] uppercase font-normal hover:text-[#1A1A1A] transition-colors">Work</a></li>
          <li><a href="#" className="text-[16px] text-[#444] tracking-[0.08em] uppercase font-normal hover:text-[#1A1A1A] transition-colors">Services</a></li>
          <li><a href="#" className="text-[16px] text-[#444] tracking-[0.08em] uppercase font-normal hover:text-[#1A1A1A] transition-colors">Blog</a></li>
        </ul>
        <a href="#" className="text-[16px] text-[#1A1A1A] tracking-[0.08em] uppercase font-medium border-b border-[#1A1A1A] pb-px hover:opacity-60 transition-opacity">
          Contact →
        </a>
      </nav>
